...
- A static /health.html page is also available with the same meta (no React boot required) to make readiness checks fast and low-memory. This file is located at public/health.html and is shipped in the build output.
